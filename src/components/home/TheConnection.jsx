...
export default function TheConnection() {
  ...
  return (
    <Chapter id="connection" index={3} label="The Connection" tone="dark" pin scrub={2} onProgress={onProgress}>
      <div className="relative min-h-screen">
        ...
        <div className="u-container relative z-10 flex min-h-screen items-center">
          <div className="grid w-full gap-10 lg:grid-cols-3">
            <div>
              <p className="u-label text-accent">The connection · Nadd Al Hamar</p>
            ...
            <div className="flex flex-col justify-between">
              <div>
                ...
                <p className="mt-3 font-body text-body text-paper-50/85">The drawing, built. Planning, engineering and delivery meeting on the same ground — where DMF lives.</p>
              </div>
